...
<head>
    ...
    <meta name="description" content="Contact UrbanPulse for any inquiries or support.">
    ...
    <style>
        ...
        * {
        ...
        .contact-form-container .alert i {
            font-size: 1.2rem;
        }
            ...
            <div class="contact-form-container">
                ...
                <form method="POST" action="contact.php">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter your name" required aria-label="Name">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="message" name="message" rows="5" placeholder="Your message" required aria-label="Message"></textarea>
                    </div>
